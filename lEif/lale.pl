...
if ($Value eq "EMPTY")
{
    print "> lale: Eingabe: Neu, Laden, Ende.\n";
}
elsif ($Value eq "SAME")
{
    print "> lale: Eingabe: Laden, Test, Neu, Ende, Zeigen\n";
}
elsif ($Value eq "CHANGED")
{
    print "> lale: Eingabe: commads: Neu, Test, Zeigen, Ende, Laden\n";
}
